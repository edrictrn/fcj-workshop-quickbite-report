...
{{< report-image src="images/5-Workshop/quickbite-aws-architecture-ha.png" alt="QuickBite AWS architecture diagram" caption="The two-Availability-Zone high-availability architecture deployed with Terraform." >}}
