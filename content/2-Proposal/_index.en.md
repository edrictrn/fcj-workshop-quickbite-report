...
{{< report-image src="images/5-Workshop/quickbite-aws-architecture-ha.png" alt="QuickBite high-availability AWS architecture" caption="QuickBite deployed in ap-southeast-1 with Terraform, two Availability Zones, ALB, EC2 Auto Scaling, RDS Multi-AZ, CloudFront, S3, ECR, Secrets Manager, Systems Manager, CloudWatch, and SNS." >}}
...
- [QuickBite source code](https://github.com/edrictrn/quickbite).
