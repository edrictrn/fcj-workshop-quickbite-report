...
{{< report-image src="images/5-Workshop/quickbite-aws-architecture-ha.png" alt="Kiến trúc QuickBite High Availability trên AWS" caption="Kiến trúc QuickBite được triển khai tại ap-southeast-1 bằng Terraform, sử dụng hai Availability Zone, ALB, EC2 Auto Scaling, RDS Multi-AZ, CloudFront, S3, ECR, Secrets Manager, Systems Manager, CloudWatch và SNS." >}}
...
- [Source code QuickBite](https://github.com/edrictrn/quickbite).
